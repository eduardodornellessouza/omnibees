...
{
    /// <summary>
    /// Class that stores the arguments for the UpdateGuest RESTfull operation.
    ...
    /// </summary>
    [DataContract]
    public class UpdateThirdPartyIntermediaryRequest : RequestBase
    {
        [DataMember]
        ...
        /// Dependent of this the behavior of Update will be different.
        /// </summary>
        [DataMember]
