...
{
    [DataContract]
    public class RateRoomDetailsDataWithChildRecordsCustom : ContractBase
    {
        public RateRoomDetailsDataWithChildRecordsCustom()
        {
        }
        ...
        [DataMember(IsRequired = true, EmitDefaultValue = false)]
        public long RRDFromDate { get; set; }

        /// <summary>Data de fim</summary>
        [DataMember(IsRequired = true, EmitDefaultValue = false)]
        public long RRDToDate { get; set; }
        ...
        /// <summary>Lista com número de adultos ex: '1,2,3,4'
        /// ExtraBed é o 0 sendo que deve ser o 1º elemento da lista.</summary>
        [DataMember(IsRequired = true, EmitDefaultValue = false)]
    ...
    //add messages
    public enum UpdateRatesStatusCode
    {
        Success = 0,
        PartialSuccess = 1,
        Failed = 2
